...
public class FahrenheitToCelsiusServiceLocator extends
		org.apache.axis.client.Service implements
		com.temperature.webservices.FahrenheitToCelsiusService {
	...
	public FahrenheitToCelsiusServiceLocator(java.lang.String wsdlLoc,
	...
	public com.temperature.webservices.FahrenheitToCelsius getFahrenheitToCelsius(
		...
		try {
			com.temperature.webservices.FahrenheitToCelsiusSoapBindingStub _stub = new com.temperature.webservices.FahrenheitToCelsiusSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (com.temperature.webservices.FahrenheitToCelsius.class
					.isAssignableFrom(serviceEndpointInterface)) {
				com.temperature.webservices.FahrenheitToCelsiusSoapBindingStub _stub = new com.temperature.webservices.FahrenheitToCelsiusSoapBindingStub(
						new java.net.URL(FahrenheitToCelsius_address), this);
				_stub.setPortName(getFahrenheitToCelsiusWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName(
				"http://webservices.temperature.com",
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName(
					"http://webservices.temperature.com", "FahrenheitToCelsius"));
		}
